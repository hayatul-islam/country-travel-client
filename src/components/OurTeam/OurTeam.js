                ...
                <div className="row team-container text-center">
                    <div className="col-md-3">
                        <div className="border pt-4 pb-2 mb-5 px-2">
                            ...
                            <p>Elite level athlete and two-sport star. Has length and frame to fill out to 195 pounds. First-team. </p>
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="border pt-4 pb-2 mb-5 px-2">
                            ...
                            <small className="text-danger">CUSCO GUIDE</small>
                            <h4>Robert Spark</h4>
                            <p>Sparks was convicted in the 2007 stabbing deaths of his family members in his Dallas home.</p>
                        </div>
                    </div>
                    <div className="col-md-3 ">
                        <div className="border pt-4 pb-2 mb-5 px-2">
                            ...
                            <small className="text-danger">CUSCO GUIDE</small>
                            <h4>Stephen Hoque</h4>
                            <p>Abeer will be reading from her memoir Olive Witch and Stephen from his new novel Zeke vs.</p>
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="border pt-4 pb-2 mb-5 px-2">
                            ...
                            <small className="text-danger">CUSCO GUIDE</small>
                            <h4>Peter Reever</h4>
                            <p>Research genealogy for Johann Reever of Manor Township, Lancaster, Lancaster, Pennsylvania.</p>
                        </div>
                    </div>
                </div>
            </div>
